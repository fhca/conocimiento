...
# DNS
Domain Name Service (Servicio de Nombres de Dominio). Es un [[#servidor]] que traduce la dirección alfanumérica de otro servidor (por ejemplo "localhost" o "www.wikipedia.org") a dirección numérica (por ejemplo 127.0.0.1). Es utilizado ampliamente en internet pues los humanos solemos recordar más los nombres que los números de dirección. Hoy en día es difícil estar siquiera enterado de que usamos este servicio siempre que usamos internet, pues además sus clientes directos son los navegadores y otros programas que usan la red: y realmente sabemos algo de ello cuando necesitamos configurarlo.
