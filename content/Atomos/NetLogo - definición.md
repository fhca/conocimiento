...
---
Netlogo es un ambiente gratuito de programación utilizando el paradigma de Programación Basada en Agentes (ABM por sus siglas en inglés). Fue creado por Uri Wilensky en el CCL de la Universidad Northwestern. Se puede descargar o usar desde una página web.